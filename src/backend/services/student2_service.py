...
class StudentService2:
    ...
    def get_all_students():
        ...
        hobby_time_data = requests.get(f"{StudentService2.BASE_URL}/hobby_time").json()['hobby_time']
        vg_time_data = requests.get(f"{StudentService2.BASE_URL}/vg_time").json()['vg_time']
        ...
        for student in student_data:
            ...
            vg_time = next(vt for vt in vg_time_data if vt["vg_time_id"] == student["vg_time_id"])
